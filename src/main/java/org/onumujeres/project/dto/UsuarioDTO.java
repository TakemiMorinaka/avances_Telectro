...
public class UsuarioDTO {
    ...
    private Integer distritoId; // Usar Integer para permitir valores nulos
    private Integer zonaId;     // Usar Integer para permitir valores nulos
